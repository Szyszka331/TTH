import {CLASSES,MONSTERS,ITEMS,QUESTS,SKILLS,PETS,RECIPES,DUNGEONS,BUILDINGS} from './data.js?v=2530';
...
function updateLiveMapPosition(){
 ...
 const hud=document.querySelector('[data-live-gps]');if(hud)hud.textContent=`GPS ±${Math.round(p.accuracy||0)} m`;
 refreshNearbyTray();
}
