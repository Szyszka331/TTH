import {CLASSES,MONSTERS,ITEMS,QUESTS,SKILLS,PETS,RECIPES,DUNGEONS,BUILDINGS} from './data.js?v=2570';
...
function closeModal(){document.querySelector('.modal-back')?.remove();document.body.classList.remove('modal-open');document.body.classList.remove('building-open')}
